...
Original file is located at
    https://colab.research.google.com/drive/1yz9LbTciXV70bMWT1vlcKZwn5w0hnTSH
"""
...
cm = '&access_token=a93eb5c1a93eb5c1a93eb5c19ea9493113aa93ea93eb5c1c9bea86d36d437768354ba62&v=5.130'
...
def clicked():
    ...
    s = requests.get('https://api.vk.com/method/users.get?user_ids=' + uid + '&fields=uid,first_name,last_name' + cm).text
    p = json.loads(s)
    ...
    s=requests.get('https://api.vk.com/method/friends.get?user_id=' + uid + '&fields=uid,%20first_name,%20last_name&count='+ count + cm).text
    p = json.loads(s)
    ...
    for x in p['response']['items']:
        ...
        s=requests.get('https://api.vk.com/method/friends.get?user_id=' + fr[i] + '&fields=uid,%20first_name,%20last_name' + cm).text
        p = json.loads(s)
